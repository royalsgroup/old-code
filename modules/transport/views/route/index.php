                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         <table style="width:100%;" class="fn_edit_stop_container responsive"> 
                                            ...
                                            <?php $couter = 1; foreach($route_stops as $obj){
                                                $aYearlyStopFare = $obj->yearly_stop_fare ? json_decode($obj->yearly_stop_fare,true) : array();
                                                $iSTopFare = $aYearlyStopFare[$academic_year_id] ?? $obj->stop_fare;
                                                ?> 
                                            <tr>               
                                              <td>                                                  
                                              ...
                                              <td>
                                                  <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='text' name="stop_fare[]" value="<?php echo $iSTopFare; ?>" placeholder="<?php echo $this->lang->line('stop_fare'); ?>"/>
                                              </td>
                                              <td>
                                                  <!-- <?php if($couter > 1){ ?>
