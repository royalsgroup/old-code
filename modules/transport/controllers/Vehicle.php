...
class Vehicle extends MY_Controller {
    ...
    * ********************************************************** */
    private function _get_posted_vehicle_data() {
		...
		if($this->input->post('insurance_from') != ''){		
			$data['insurance_from'] = date('Y-m-d', strtotime($this->input->post('insurance_from')));
		}
		else{
			$data['insurance_from'] = null;
		}
		if($this->input->post('insurance_to') != ''){		
        $data['insurance_to']   = date('Y-m-d', strtotime($this->input->post('insurance_to')));
		}
		else{
			$data['insurance_to']   =null;
		}
		
		if($this->input->post('pollution_from') != ''){		
			$data['pollution_from'] = date('Y-m-d', strtotime($this->input->post('pollution_from')));
		}
		else{
			$data['pollution_from'] = null;
		}
		if($this->input->post('pollution_to') != ''){		
        $data['pollution_to']   = date('Y-m-d', strtotime($this->input->post('pollution_to')));
		}
		else{
			$data['pollution_to']   =null;
		}
        if ($this->input->post('id')) {
