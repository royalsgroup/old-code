...
class Student_Model extends MY_Model {
    ...
    public function get_student_list($school_id = null, $class_id = null, $section_id = null, $academic_year_id = null){
        ...
        if( $this->session->userdata('role_id') == TEACHER)
        {
            ...
            $this->db->or_where('SE.teacher_id', $this->session->userdata('profile_id'));
            $this->db->group_end();
        }
    ...
    public function get_teacher_section_classes(){
		$this->db->select('SE.class_id');
    ...
    public function update_student_attendance($data,$where = null,$day_col){
        if($where['school_id'])
        {
            ...
            return  $this->db->update('student_attendances',$data);
        }
