<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <?php if ((isset($date) && !empty($date)) || (isset($month) && !empty($month)) ) { ?>
                <div class="x_content">
                    <div class="row">
...
var __tableDistroyed = 0;
 var date='<?php print $date; ?>';
 var month='<?php print $full_month; ?>';
      ...
      'serverMethod': 'post',
      'ajax': {
          'url':'<?php echo site_url("attendance/employee/get_list"); ?>',
		  'data': {'school_id': sch_id,'date':date,'month':month}
      },
      buttons: [
    ...
    var employee_id = $(obj).prop('checked') ? $(obj).attr('itemid') : '';
