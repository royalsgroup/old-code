...
<div class="col-md-3 col-sm-3 col-xs-12">									
                                    ...
                                    <label for="head_type"><?php echo $this->lang->line('debit_ledger'); ?> <span class="required">*</span></label>                                    
								...
								<div class="col-md-3 col-sm-3 col-xs-12">									
								<div class="item form-group">
                                    <label for="head_type"><?php echo $this->lang->line('voucher'); ?> <span class="required">*</span></label>                                    
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('payroll/grade/edit/'.$grade->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="item form-group">
                                    <label for="head_type"><?php echo $this->lang->line('debit_ledger'); ?> <span class="required">*</span></label>                                    
                                        <select  class="form-control col-md-7 col-xs-12" name="debit_ledger_id" id="edit_debit_ledger_id" required='required'>
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
 ...
 <script type="text/javascript">
    ...
    $('.fn_school_id').on('change', function(){
        ...
        <?php if(isset($school_id) && !empty($school_id)){ ?>            
			...
			voucher_id =  '<?php echo $grade->voucher_id; ?>';
         <?php } ?> 
		...
		$.ajax({       
            ...
            data   : { school_id:school_id, voucher_id:voucher_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {  
