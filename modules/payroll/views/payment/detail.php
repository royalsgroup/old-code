    ...
    <div class="row">                  
								...
								<div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
												...
												<input class="form-control col-md-7 col-xs-12 incomeInput " type='number' name='cat[<?php print $e->id; ?>]' value='<?php print $e->cal_amount; ?>'  <?php if($e->set_max_amount_limit){ echo " max=\"$e->max_amount_possible\" "; } ?>   <?php echo $iReadonly ?  "readonly" : "" ; ?>>
											</div>
								</div>
								<?php }?>
								</div>
								...
								<div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="total_allowance"><?php print $e->name; ?></label>
												<input class="form-control col-md-7 col-xs-12 expInput " type='number' name='cat[<?php print $e->id; ?>]' value='<?php print $e->cal_amount; ?>'  <?php echo $iReadonly ?  "readonly" : "" ; ?>/>
											</div>
								</div>
								<?php }?>
								</div>
