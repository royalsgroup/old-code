                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($discounts) && !empty($discounts)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->type == "amount" ? "Amount" : "Percentage" ; ?></td>                                            
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_discount">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('accounting/discount/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type"><?php echo $this->lang->line('discount_type'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <select class="form-control  col-md-7 col-xs-12" name="type" id="add_type" >
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="amount"><span id="add_amount_label"><?php echo $this->lang->line('amount'); ?> (%)</span><span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <select class="form-control  col-md-7 col-xs-12" name="type" id="edit_type" >
                                           <option value="percentage" <?php echo isset($discount->type) && $discount->type == "percentage" ? "selected" : ''; ?>>Percentage</option>
                                           <option value="amount"  <?php echo isset($discount->type) && $discount->type == "amount" ? "selected" : ''; ?>>Amount</option>
                                         </select>
                                    </div>
                                </div>     
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="amount"><span id="edit_amount_label"><?php echo isset($discount->type) && $discount->type == "amount" ? $this->lang->line('amount'):  $this->lang->line('amount')." (%)" ; ?>  </span><span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
 ...
 <script type="text/javascript">
    ...
    $("#edit").validate();  
     ...
     $('#edit_type').on('change', function() {
        ...
        {
            $('#edit_amount_label').html("Amount (%)")
        }
        else
        {
            console.log($('#edit_amount_label'))
            $('#edit_amount_label').html("Amount")
        }
