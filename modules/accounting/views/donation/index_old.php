                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($invoices) && !empty($invoices)){ $b = 0; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->net_amount; if($obj->emi_type){echo "(EMI)";}?></td>
    ...
    var $emidata = $('#emidata');
                ...
                if(value == 0){  
                              ...
                              url: "<?php echo base_url() ?>" + "accounting/invoice/emi",
                               type: 'POST',
                              data: {"emidata": onload, "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"},
                        ...
                        $.ajax({
                              url: "<?php echo base_url() ?>" + "accounting/invoice/emi_find",
                               type: 'POST',
                              data: {"feetype": feetype, "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"},
