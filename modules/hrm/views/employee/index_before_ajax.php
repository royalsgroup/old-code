                                 ...
                                 <tbody>   
                                    <?php  $count = 1; if(isset($employees) && !empty($employees)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if($obj->joining_date!= '0000-00-00') echo $obj->joining_date; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <!-- ak -->
                                                 ...
                                                 <?php if(has_permission(EDIT, 'teacher', 'teacher')){ ?>
                                                    <a href="<?php echo site_url('teacher/add_alumni/'.$obj->id); ?>" onclick="javascript: return confirm('Are you sure you want to make Alumi this');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Alumi </a>
                                                <?php } ?> 
                                                ...
                                                <?php if(has_permission(DELETE, 'hrm', 'employee')){ ?> 
                                                    <?php if($obj->id != 1){ ?> 
                                                        <a href="<?php echo site_url('hrm/employee/alumni_emp/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alumni_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('alumni'); ?> </a>
                                                    <?php } ?>
                                                <?php } ?>
                                ...
                                <div class="row">
									...
									<div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="employee_code"  id="add_employee_code" value="<?php echo isset($post['employee_code']) ?  $post['employee_code'] : ''; ?>" placeholder="<?php echo $this->lang->line('employee_code'); ?>" required="required" type="text" autocomplete="off">
							   ...
							   <?php }?>
                                ...
                                <div class="row">
									...
									<div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="national_id"><?php echo $this->lang->line('employee_code'); ?><span class="required">*</span> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="employee_code"  id="edit_employee_code" value="<?php echo isset($employee->employee_code) ?  $employee->employee_code : ''; ?>" placeholder="<?php echo $this->lang->line('employee_code'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('employeee_code'); ?></div> 
                                        </div>
                                    </div>
                                  <!--  <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="username"  id="username"  value="<?php echo isset($employee->username) ?  $employee->username :''; ?>" placeholder="<?php echo $this->lang->line('username'); ?>"  type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('username'); ?></div>
                                        </div>
                                    </div>   
