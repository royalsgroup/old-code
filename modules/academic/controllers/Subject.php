...
class Subject extends MY_Controller {
    ...
    * ********************************************************** */
    public function index($class_id = null) {
        ...
        if(!$class_id  && $this->session->userdata('role_id') == STUDENT &&  $this->session->userdata('class_id'))
        {  
            redirect('academic/subject/index/'.$this->session->userdata('class_id'));    
        }
        ...
        {
            $school_id  = $this->session->userdata('class_id');
        ...
        if($this->session->userdata('role_id') != SUPER_ADMIN){            
            ...
            //$this->data['classes'] = $this->subject->get_class_by_session('classes', $condition['school_id']);

            
        }
        if($this->data['filter_school_id'] == null)
        {
