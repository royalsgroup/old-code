                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_liveclass_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'academic', 'liveclass')) { ?>
                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('academic/liveclass/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="#tab_add_liveclass" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } ?>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                                ...
                                <select class="form-control col-md-7 col-xs-12" onchange="get_live_class_list_by_class(this.value);">
                                    ...
                                    <?php foreach ($class_list as $obj) { ?>
                                        <?php if ($this->session->userdata('role_id') == STUDENT) { ?>
                                            ...
                                            <option value="<?php echo site_url('academic/liveclass/index/' . $obj->id); ?>" <?php if (isset($class_id) && $class_id == $obj->id) {
                                                                                                                                echo 'selected="selected"';
                            ...
                            <div class="x_content">
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $count = 1;
                                        if (isset($live_classes) && !empty($live_classes)) { ?>
                                            <?php foreach ($live_classes as $obj) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                        $class_type = $obj->class_type == 'zoom' ? 'Zoom' : ($obj->class_type == 'google_meet' ? "Google Meet" : 'Jitsi');
                                                        $flag = 1;;
                                                        ...
                                                        if ($flag == 2) {
                                                            ...
                                                            echo $a . "<span class=' " . $button . " '>" . $status . "</span></a>";
                                                        } else {
                                                    ...
                                                    <td>
                                                        <?php if (has_permission(VIEW, 'academic', 'liveclass') && ($this->session->userdata('role_id') == STUDENT || $this->session->userdata('role_id') == GUARDIAN)) { ?>
                                                            ...
                                                            <?php if ($flag == 2) { 
                                                                $meeting_link =  $obj->class_type =="zoom" ||  $obj->class_type =="google_meet" || $obj->class_type =="youtube" ? $obj->meeting_link :  site_url('academic/liveclass/start/' . $obj->id) ;
                                                                ?>
                                                                
                                                                <a href="<?php echo $meeting_link  ?>" target="_blank"  class="btn btn-success btn-xs"><i class="fa fa-sitemap"></i> <?php echo $this->lang->line('join_class')?>  [ <?php echo $class_type; ?> ]</a>
                                                            <?php } elseif ($flag == 1) { ?>
                                                                <a onclick="javascript: return confirm('<?php echo $this->lang->line('waiting'); ?>');" class="btn btn-info btn-xs"><i class="fa fa-hand-o-up"></i> <?php echo $this->lang->line('waiting'); ?> [ <?php echo $class_type; ?> ]</a>
                                                            <?php } else { ?>
                                                                <a onclick="javascript: return confirm('<?php echo $this->lang->line('expire'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-hand-o-up"></i> <?php echo $this->lang->line('expire'); ?> [ <?php echo $class_type; ?> ]</a>
                                                            <?php } ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if(has_permission(ADD, 'academic', 'liveclass')){ ?>
                                                            <a href="<?php echo site_url('academic/liveclass/edit/'.$obj->id.'?duplicate=1'); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Duplicate</a>
                                                        <?php } ?>
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-7 col-xs-12" name="class_id" id="add_class_id"  onchange="get_subject_by_class(this.value, ''); get_section_by_class(this.value, '');">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subject_id"><?php echo $this->lang->line('subject'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="fn_add_zoom_setting display">
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="meeting_link"><?php echo $this->lang->line('meeting_link'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="meeting_link" id="add_meeting_link" value="<?php echo isset($post['meeting_link']) ?  $post['meeting_link'] : ''; ?>" placeholder="<?php echo $this->lang->line('meeting_link'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('meeting_link'); ?></div>
                                        </div>
                                    </div>
                                    <!-- <div class="item form-group">
                        ...
                        <?php if (isset($edit)) { ?>
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_liveclass">
                                <div class="x_content">
                                    ...
                                    <input type="hidden" name="duplicate" value="<?php echo $duplicate ?? 0 ?>">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="class_id" id="edit_class_id" required="required" onchange="get_subject_by_class(this.value, ''); get_section_by_class(this.value, '');">
                                                <option value="0" <?php if(!$live_class->class_id) echo 'selected="selcted"' ?>>All</option>
                                                <?php foreach ($classes as $obj) { ?>
                                                    <?php
                                                    if ($this->session->userdata('role_id') == TEACHER) {
                                                        if (!in_array($obj->id, $teacher_access_data)) {
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php if ($obj->id == $live_class->class_id) {
                                                                                                echo 'selected="selected"';
                                                                                            } ?>><?php echo $obj->name; ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subject_id"><?php echo $this->lang->line('subject'); ?> 
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12 data_subject" name="subject_id" id="edit_subject_id" >
                                                <option value="0">All</option>
                                            </select>
                                            <div class="help-block"><?php echo form_error('subject_id'); ?></div>
                                        </div>
                                    ...
                                    <?php if ($this->session->userdata('role_id') != TEACHER) { ?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control col-md-7 col-xs-12 data_subject" name="teacher_id" id="edit_teacher_id">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <?php if (isset($teachers) && !empty($teachers)) { ?>
                                                        <?php foreach ($teachers as $obj) { ?>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12 data_subject" name="class_type" id="add_class_type" required="required" onchange="set_live_class_type(this.value, 'edit');">
                                                ...
                                                <?php if(isset($live_class->class_type) && $live_class->class_type == 'jitsi') {?>
                                                <option value="jitsi" <?php echo isset($live_class->class_type) && $live_class->class_type == 'jitsi' ?  'selected="selected"' : ''; ?>>Jitsi Meet</option>
                                                <?php }?>
                                                <option value="youtube" <?php echo isset($live_class->class_type) && $live_class->class_type == 'youtube' ?  'selected="selected"' : ''; ?>>Youtube</option>
                                                <option value="google_meet" <?php echo isset($live_class->class_type) && $live_class->class_type == 'google_meet' ?  'selected="selected"' : ''; ?>>Google Meet</option>
                                            </select>
                                            <div class="help-block"><?php echo form_error('class_type'); ?></div>
                                        </div>
                                    </div>

                                    <div class="fn_edit_zoom_setting <?php echo isset($live_class->class_type) && ($live_class->class_type == 'zoom' || $live_class->class_type == 'google_meet') ? '' : 'display'; ?>">
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="meeting_link"><?php echo $this->lang->line('meeting_link'); ?> <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="meeting_link" id="edit_meeting_link" value="<?php echo isset($live_class->meeting_link) ?  $live_class->meeting_link : ''; ?>" placeholder="<?php echo $this->lang->line('meeting_link'); ?>" required="required" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('meeting_link'); ?></div>
                                            </div>
                                        </div>
                                        <!-- <div class="item form-group">
...
<script type="text/javascript">
    ...
    function set_live_class_type(class_type, form_mode) {
        ...
        } else if(  class_type == 'google_meet' || class_type == 'youtube')
        {
            $('.fn_' + form_mode + '_zoom_setting').show();
            $('#' + form_mode + '_meeting_id').prop('required', true);
        }
