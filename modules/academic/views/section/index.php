                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_section">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/section/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="teacher_id"><?php echo $this->lang->line('section'); ?> <?php echo $this->lang->line('teacher'); ?> 
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
 ...
 <script type="text/javascript">
    ...
    $('.fn_school_id').on('change', function(){
       ...
       $.ajax({       
            ...
            data   : { school_id:school_id, class_id:class_id,non_alumni:1},               
            async  : false,
