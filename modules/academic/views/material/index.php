                                 ...
                                 <?php }else{  ?> 
                                    <select  class="form-control col-md-7 col-xs-12" onchange="get_material_list_by_class(this.value);">
                                        <?php if($this->session->userdata('role_id') != STUDENT){ ?>
                                           ...
                                           <option value="<?php echo site_url('academic/material/index/0'); ?>" <?php if(isset($class_id) && $class_id == 0){ echo 'selected="selected"';} ?>>All</option> 
                                        <?php } ?>        
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="class_id"  id="add_class_id" required="required" onchange="get_subject_by_class(this.value, '');" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <option value="0" <?php echo isset($post['class_id']) && $post['class_id'] == 0 ?  'selected="selected"' : ''; ?>>All</option> 
                                            <?php foreach($classes as $obj ){ ?>
                                                <?php
                                                if($this->session->userdata('role_id') == TEACHER || ($filter_school_id && $obj->school_id!= $filter_school_id)){
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_material">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('academic/material/edit/'.$material->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="class_id"><?php echo $this->lang->line('class').$material->class_id ;; ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="class_id"  id="edit_class_id" required="required" onchange="get_subject_by_class(this.value, '');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>-- </option> 
                                            <option value="0"  <?php echo  $material->class_id == "0" ?  'selected="selected"' : ''; ?>>All</option> 
...
<?php if(!isset($material->material) || !$material->material){ ?>
$('#edit').validate({
    rules: {       
        material: {
            required: true,
...
<script type="text/javascript"> 
 ...
 <script type="text/javascript">
      ...
      'serverMethod': 'post',
      'ajax': {
          'url':'<?php echo site_url("academic/material/get_list"); ?>',
