                    ...
                    <tbody id="fn_mark">   
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $position = get_position_in_class($school_id, $academic_year_id, $current_class_id, $obj->id); ?>
                                ...
                                <tr>
                                    <td><input type="checkbox" class="select_student_check" name="students[]" value="<?php echo $obj->id;?>"></td>
                                    ...
                                    <td>
                                        <select  class="form-control col-md-7 col-xs-12" name="promotion_class_id[<?php echo $obj->id; ?>]"  required="required">                                
                                            <option value="<?php echo $next_class->id; ?>" selected="selected"><?php echo $next_class->name; ?></option>
                                            <option value="<?php echo $current_class->id; ?>"><?php echo $current_class->name; ?></option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="number" value="<?php echo isset($enroll) && $enroll->roll_no ? $enroll->roll_no :  $count; ?>"  name="roll_no[<?php echo $obj->id; ?>]"  class="form-control col-md-7 col-xs-12 small-field" required="required"  autocomplete="off"/>
                                    </td>
                                </tr>
                            <?php 
                                    $count++;
...
<!-- Super admin js START  -->
 <script type="text/javascript">
  $("#select_all").click(function () {
     $('.select_student_check:checkbox').not(this).prop('checked', this.checked);
 });
