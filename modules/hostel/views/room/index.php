                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($rooms) && !empty($rooms)){ ?>
                                        ...
                                        $aYearlyStopFare = $obj->yearly_room_rent ? json_decode($obj->yearly_room_rent,true) : array();
                                        $cost = $aYearlyStopFare[$academic_year_id] ?? $obj->cost;    
                                        ?>
                                        <tr>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_room">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('hostel/room/edit/'.$room->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php 
                                $aYearlyStopFare = $room->yearly_room_rent ? json_decode($room->yearly_room_rent,true) : array();
                                $cost = $aYearlyStopFare[$academic_year_id] ?? $room->cost;    
                                ?>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cost"><?php echo $this->lang->line('cost_per_seat'); ?>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="cost"  id="cost" value="<?php echo isset($cost) ?  $cost : ''; ?>" placeholder="<?php echo $this->lang->line('cost_per_seat'); ?>" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('cost'); ?></div>
                                    </div>
                                </div>
