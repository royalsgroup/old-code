                               ...
                               <?php echo form_open(site_url('hostel/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="health_condition"><?php echo $this->lang->line('facilities'); ?> </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										<?php 										
										$facilities = get_hostel_facilities(); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="item form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
										<?php 
										$farr=explode(",",$hostel->facilities);
										$facilities = get_hostel_facilities(); ?>
                                                <?php foreach($facilities as $key=>$value){ ?><span>
													<input type="checkbox" name="facilities[]" value="<?php print $key; ?>"  <?php if(in_array($key,$farr)){ echo 'checked="checked"'; } ?>> <?php echo $value; ?></span>                                                   
                                                <?php } ?>                                    
