                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_type">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('leave/type/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12"  name="role_id"  id="role_id" required="required">
                                            ...
                                            <option value="-1" ><?php echo $this->lang->line('multiple_roles'); ?></option> 
                                            <?php foreach($roles as $obj ){  ?>
                                                 <?php if(in_array($obj->id, array(SUPER_ADMIN, GUARDIAN))){ continue;} ?>
                                                <option value="<?php echo $obj->id; ?>" <?php echo  isset($post['role_id']) && $post['role_id'] == $obj->id ? 'selected' : '' ?>><?php echo $obj->name; ?></option>
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('role_id'); ?></div>
                                        <div id="roles-checkbox-row" class="<?php echo  isset($post['role_id']) && $post['role_id'] == -1 ? '' : 'hidden' ?>">
                                            <?php 
                                            
                                            foreach($roles as $obj){ ?>
                                                <?php if(in_array($obj->id, array(SUPER_ADMIN, GUARDIAN))){ continue;} ?>
                                                <div class="col-sm-4"><input name="roles[]" type="checkbox" value="<?php echo $obj->id; ?>" > <?php echo $obj->name; ?></div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type"><?php echo $this->lang->line('paid_leave'); ?>  </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12" >
                                        <input  class=" col-md-7 col-xs-12"  name="paid_leave"  id="paid_leave" value="1"  type="checkbox"<?php echo isset($post['paid_leave']) ?  "checked='checked'" : ''; ?> style="width:30px">
                                        <div class="help-block"><?php echo form_error('paid_leave'); ?></div>
                                    </div>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_type">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('leave/type/edit/'.$type->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type"><?php echo $this->lang->line('paid_leave'); ?>  </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12" >
                                        <input  class=" col-md-7 col-xs-12"  name="paid_leave"  id="paid_leave" value="1"  type="checkbox" <?php echo isset($type) && $type->paid_leave  ?  "checked='checked'" : ''; ?> style="width:30px">
                                        <div class="help-block"><?php echo form_error('paid_leave'); ?></div>
                                    </div>
 ...
 <script type="text/javascript">
        $(document).ready(function() {
            $('#role_id').change(function(){
                ...
                if($(this).val() == "-1")
                {
                    $('#roles-checkbox-row').removeClass('hidden');
                }
                else $('#roles-checkbox-row').addClass('hidden');
            })
