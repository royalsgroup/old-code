                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="li-class-list">
                            <?php if($this->session->userdata('role_id') == SUPER_ADMIN || $this->session->userdata('dadmin') == 1){  ?>                                  
                                <select  class="form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_approved_leave_by_school_filter(this.value)">
                                    <option value="<?php echo site_url('leave/approve/index'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
 ...
 <script type="text/javascript">
   ...
   $(document).ready(function() {
    var sch_id='<?php print $filter_school_id; ?>';
      ...
      'serverMethod': 'post',
      'ajax': {
          'url':'<?php echo site_url("/leave/approve/get_leave_list"); ?>',
		  'data': {'school_id': sch_id,'status':0}
      },
            iDisplayLength: 15,
            buttons: [
                'copyHtml5',
