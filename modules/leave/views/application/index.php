 ...
 <script type="text/javascript">
   ...
   <?php } ?>
    ...
    function get_user_by_role(role_id, user_id){       
       ...
       // get_leave_type_by_school1(school_id, type_id);
   }
   ...
   $(document).ready(function() {
    var sch_id='<?php print $filter_school_id; ?>';
      ...
      'serverMethod': 'post',
      'ajax': {
          'url':'<?php echo site_url("/leave/application/get_leave_list"); ?>',
...
?>
 ...
 <script>
   function get_leave_type_by_school1(school_id, type_id){
   
        var role_id = $('#'+form+'_role_id').val();
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_leave_type_by_school1'); ?>",
            data   : { school_id: school_id, role_id:role_id, type_id:type_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
