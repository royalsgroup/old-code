                            ...
                            <?php }else{  ?> 
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_student_by_class(this.value);">
                                    <?php if($this->session->userdata('role_id') != STUDENT){ ?>    
                                        <option value="<?php echo site_url('student/alumni/'); ?>">--<?php echo $this->lang->line('select'); ?>--</option> 
                                    <?php } ?>
                                    ...
                                    <?php foreach($classes as $obj ){ ?>
                                        <?php if($this->session->userdata('role_id') == STUDENT){ ?>
                                            ...
                                            <option value="<?php echo site_url('student/alumni/'.$obj->id); ?>" <?php if(isset($class_id) && $class_id == $obj->id){ echo 'selected="selected"';} ?> ><?php echo $this->lang->line('class'); ?> <?php echo $obj->name; ?></option>
...
<!-- Super admin js START  -->
 ...
 <script type="text/javascript">
      ...
      'serverMethod': 'post',
      'ajax': {
          'url':'<?php echo site_url("student/get_list_alumni"); ?>',
		  'data': {'school_id': sch_id, 'class_id': class_id}
              ...
              "columnDefs": [
                    ...
                    {
						"targets": [9,10,11,12,13,15,16,17] ,
						"searchable": false,
                        "visible": false,
