                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('message/text/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12"  name="template"  id="fn_template" onchange="get_template(escape(this.value))" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control" name="body" id="text_body"   required="required" placeholder="<?php echo $this->lang->line('sms'); ?>" readonly><?php if(isset($message)){ echo $message->body;} ?></textarea>
 ...
 <script type="text/javascript">
  ...
  <?php if(isset($message)){ ?>
   ...
   function get_template(template){       
        ...
        $('#text_body').html(__tenplates[template]);
   ...
   $.ajax({       
       type   : "POST",
       url    : "<?php echo site_url('ajax/get_sms_template_by_role_new'); ?>",
       ...
       success: function(response){                                                   
          if(response)
          {
            __tenplates = response.templates;
              $('#fn_template').html(response.options); 
          }
       }
   }); 
}
