<div class="" data-example-id="togglable-tabs">
    <ul  class="nav nav-tabs bordered">
        ...
        <li class=""><a href="#tab_social_info"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-share"></i> <?php echo $this->lang->line('profile')." ".$this->lang->line('information'); ?></a> </li>
    </ul>
    <br/>
