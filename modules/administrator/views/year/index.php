                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($years) && !empty($years)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo isset($academic_years[$obj->previous_academic_year_id]) ? $academic_years[$obj->previous_academic_year_id] : '' ?></td>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_year">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('administrator/year/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="teacher_id">Previous Academic year 
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="previous_academic_year_id"  >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($years as $year_obj ){ ?>
                                            <option value="<?php echo $year_obj->id; ?>" <?php echo isset($post['previous_academic_year_id']) && $post['previous_academic_year_id'] == $year_obj->id ?  'selected="selected"' : ''; ?>><?php echo $year_obj->session_year; ?></option>
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('previous_academic_year_id'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="previous_academic_year_id"  >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($years as $year_obj ){ ?>
                                                <option value="<?php echo $year_obj->id; ?>" <?php echo isset($previous_academic_year_id) && $previous_academic_year_id == $year_obj->id ?  'selected="selected"' : ''; ?>><?php echo $year_obj->session_year; ?></option>
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('previous_academic_year_id'); ?></div>
                                    </div>
