...
class Emailsetting extends MY_Controller {
    ...
    * ********************************************************** */
    public function add() {
        ...
        $this->data['email_settings'] = $this->emailsetting->get_email_setting_list();
        $this->data['add'] = TRUE;
        $this->layout->title($this->lang->line('add') . ' ' . $this->lang->line('email') . ' ' . $this->lang->line('setting') . ' | ' . SMS);
        $this->layout->view('email_setting/index', $this->data);
    }
    ...
    * ********************************************************** */
    private function _prepare_email_setting_validation() {
        ...
        $this->form_validation->set_rules('mail_type', $this->lang->line('email') . ' ' . $this->lang->line('type'), 'trim');
