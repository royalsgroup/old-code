...
class Administrator_Model extends MY_Model {
    ...
    public function get_user_list($school_id, $role_id, $class_id, $user_id,$start=null,$limit=null,$search_text='') {
    ...
    public function get_user_list_total($school_id, $role_id, $class_id, $user_id,$search_text = null) {
