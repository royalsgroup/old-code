                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
										...
										<th><?php echo $this->lang->line('complain'); ?> <?php echo $this->lang->line('no'); ?></th>
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($complains) && !empty($complains)){ ?>
                                        ...
                                        <tr>
											...
											<td><?php echo $obj->complain_no; ?></td>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('complain/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="complain_date"><?php echo $this->lang->line('complain'); ?> <?php echo $this->lang->line('no'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="complain_no"  id="add_complain_no" value="<?php echo isset($complain_no) ?  $complain_no : ''; ?>" placeholder="<?php echo $this->lang->line('complain'); ?> <?php echo $this->lang->line('no'); ?>" readonly='readonly' required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('complain_no'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('complain/edit/'.$complain->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="complain_no"  id="add_complain_no" value="<?php echo isset($complain->complain_no) ?  $complain->complain_no : ''; ?>" placeholder="<?php echo $this->lang->line('complain'); ?> <?php echo $this->lang->line('no'); ?>" readonly='readonly' required="required" type="text" disabled="disabled" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('complain_no'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
  ...
  $('#edit_action_date').datepicker();
   ...
   <?php } ?> 
    ...
    $("document").ready(function () {
     ...
     $('.fn_school_id').on('change', function(){   
       ...
       <?php } ?>
		...
		generate_complain_no(school_id);
    });
    ...
    <?php } ?>
     <?php if (isset($school_id) && !empty($school_id)) { ?>	 
		if(form == 'add'){
			generate_complain_no(<?php print $school_id; ?>);
		}
	 <?php } ?>
	 
    function generate_complain_no(sc_id){
			// complain 
			$.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('complain/generate_complain_no'); ?>",
            data   : { school_id:sc_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {  
                  $('#'+form+'_complain_no').val(response);  
               }
            }
        }); 
	}
