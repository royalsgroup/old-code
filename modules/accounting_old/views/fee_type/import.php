<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-users"></i><small> <?php echo $this->lang->line('manage_fee_type'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <?php if(has_permission(ADD, 'accounting', 'feetype')){ ?>
                            <li  class="active"><a href="#tab_add_bulk_feetype"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('import'); ?> <?php echo $this->lang->line('fee_type'); ?></a> </li>                          
                        <?php } ?>                        
                    </ul>
                    <br/>
                    ...
                    <div class="tab-content">
                        ...
                        <div  class="tab-pane fade in active" id="tab_add_bulk_feetype">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('accounting/import/feetype'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
...
<?php /*                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <div class="btn btn-default btn-file">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12"  name="bulk_feetype"  id="bulk_feetype" type="file">
                                            </div>
                                         </div>
                                     </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a  href="<?php echo site_url('accounting/import/feetype'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
