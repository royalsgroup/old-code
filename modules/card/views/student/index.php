                                        ...
                                        <?php 
                                            ...
                                            <div class="card-block">
                                                <div class=" card-top">
                                                    ...
                                                    <div class="card-school card_school_section">
                                                        <?php $school_name  =  isset($setting->school_name) && $setting->school_name != '' ? $setting->school_name : $school->school_name;  ?>
                                                        <h2 <?php if($setting->school_name_font_size) echo 'style="font-size : "'.$setting->school_name_font_size.'px !important;"'?>> <?php echo  $school_name?> </h2>
                                                ...
                                                <div class="card-main">
                                                    ...
                                                    <div class="card-info">
                                                        <p><span class="card-title"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('name'); ?></span><span class="card-value">: <?php echo $obj->name; ?></span></p>
														<p><span class="card-title"><?php echo $this->lang->line('father'); ?> <?php echo $this->lang->line('name'); ?></span><span class="card-value">: <?php echo $obj->father_name; ?></span></p>
