                                            ...
                                            <div class="card-block" style='background: url("<?php echo UPLOAD_PATH; ?>/idcard/<?php echo $setting->background_image; ?>") no-repeat;background-size: auto;background-size: 100% 100%;'>
                                                <div class="card-top" style="background:none;">
                                                    ...
                                                    <div class="card-school" >
                                                        <h2><?php echo isset($setting->school_name) && $setting->school_name != '' ? $setting->school_name : $school->school_name; ?></h2>
                                                ...
                                                <div class="card-main">
                                                    ...
                                                    <div class="card-info" style="padding-left:26px;">
                                                        <p><span class="card-title"><?php echo $this->lang->line('employee'); ?> <?php echo $this->lang->line('name'); ?></span><span class="card-value">: <?php echo $obj->name; ?></span></p>
