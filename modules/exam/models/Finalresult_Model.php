...
class Finalresult_Model extends MY_Model {
    ...
    $this->db->select('M.*,EX.title as exam_name,S.name,S.admission_no, S.father_name, S.mother_name,S.photo, E.roll_no, E.class_id, E.section_id, C.name AS class_name, AY.session_year,SB.name as subject_name');
