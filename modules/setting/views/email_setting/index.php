                         ...
                         <div class="tab-pane fade in active"id="tab_setting">
                            <div class="x_content"> 
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="smtp_timeout"  id="smtp_timeout" value="<?php if(isset($email_setting)){ echo $email_setting->smtp_timeout;}else{ echo '5'; } ?>" placeholder="<?php echo $this->lang->line('smtp'); ?> <?php echo $this->lang->line('time_out'); ?>" type="text" autocomplete="off">
