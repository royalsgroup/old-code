                        ...
                        <div class="tab-pane fade in <?php echo isset($paypal) ? 'active':''; ?>" id="tab_paypal_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="paypal_email" value="<?php echo isset($setting) ? $setting->paypal_email : ''; ?>"  placeholder="<?php echo $this->lang->line('paypal'); ?> <?php echo $this->lang->line('email'); ?>" required="required" type="email"  autocomplete="off">
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="paypal_extra_charge" value="<?php echo isset($setting) ? $setting->paypal_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('paypal'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="text" autocomplete="off">
                        ...
                        <div class="tab-pane fade in <?php echo isset($stripe) ? 'active':''; ?> display" id="tab_stripe_setting">
                           <div class="x_content"> 
                              ...
                              <div class="item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input  class="form-control col-md-7 col-xs-12"  name="stripe_secret" value="<?php echo isset($setting) ? $setting->stripe_secret : ''; ?>"  placeholder="stripe_secret" required="required" type="text" autocomplete="off">
                              ...
                              <div class="item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input  class="form-control col-md-7 col-xs-12"  name="stripe_extra_charge" value="<?php echo isset($setting) ? $setting->stripe_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('stripe'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="text" autocomplete="off">
                        ...
                        <div class="tab-pane fade in <?php echo isset($payumoney) ? 'active':''; ?>" id="tab_pumoney_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="payumoney_key" value="<?php echo isset($setting) ? $setting->payumoney_key : ''; ?>"  placeholder="<?php echo $this->lang->line('payumoney'); ?> <?php echo $this->lang->line('key'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="payumoney_salt" value="<?php echo isset($setting) ? $setting->payumoney_salt : ''; ?>"  placeholder="<?php echo $this->lang->line('payumoney'); ?> <?php echo $this->lang->line('key_salt'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="payu_extra_charge" value="<?php echo isset($setting) ? $setting->payu_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('payumoney'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="text" autocomplete="off">
                        ...
                        <div class="tab-pane fade in <?php echo isset($ccavenue) ? 'active':''; ?> display" id="tab_ccavenue_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="ccavenue_key" value="<?php echo isset($setting) ? $setting->ccavenue_key : ''; ?>"  placeholder="<?php echo $this->lang->line('ccavenue'); ?> <?php echo $this->lang->line('key'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="ccavenue_salt" value="<?php echo isset($setting) ? $setting->ccavenue_salt : ''; ?>"  placeholder="<?php echo $this->lang->line('ccavenue'); ?> <?php echo $this->lang->line('key_salt'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="ccavenue_extra_charge" value="<?php echo isset($setting) ? $setting->ccavenue_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('ccavenue'); ?> <?php echo $this->lang->line('extra_charge'); ?>"  type="text" autocomplete="off">
                        ...
                        <div class="tab-pane fade in <?php echo isset($paytm) ? 'active':''; ?>" id="tab_paytm_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="paytm_merchant_key" value="<?php echo isset($setting) ? $setting->paytm_merchant_key : ''; ?>"  placeholder="<?php echo $this->lang->line('paytm'); ?> <?php echo $this->lang->line('merchant_key'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="paytm_merchant_mid" value="<?php echo isset($setting) ? $setting->paytm_merchant_mid : ''; ?>"  placeholder="<?php echo $this->lang->line('paytm'); ?> <?php echo $this->lang->line('merchant_mid'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="paytm_merchant_website" value="<?php echo isset($setting) ? $setting->paytm_merchant_website : ''; ?>"  placeholder="<?php echo $this->lang->line('paytm'); ?> <?php echo $this->lang->line('website'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="paytm_extra_charge" value="<?php echo isset($setting) ? $setting->paytm_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('paytm'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="text" autocomplete="off">
                        ...
                        <div class="tab-pane fade in <?php echo isset($paystack) ? 'active':''; ?>" id="tab_paystack_setting">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="stack_secret_key" value="<?php echo isset($setting) ? $setting->stack_secret_key : ''; ?>"  placeholder="<?php echo $this->lang->line('pay_stack'); ?> <?php echo $this->lang->line('secret_key'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="stack_public_key" value="<?php echo isset($setting) ? $setting->stack_public_key : ''; ?>"  placeholder="<?php echo $this->lang->line('pay_stack'); ?> <?php echo $this->lang->line('public_key'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="stack_extra_charge" id="stack_extra_charge" value="<?php echo isset($setting) ? $setting->stack_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('pay_stack'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="text" autocomplete="off">
