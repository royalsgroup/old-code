    ...
    * ********************************************************** */
    public function index($school_id = null) {
        ...
        if($this->session->userdata('role_id') != SUPER_ADMIN && $this->session->userdata('dadmin') != 1){ 
            ...
            $this->data['classes'] = $this->visitor->get_list_new('classes', $condition, '', '', '', 'id', 'ASC');
        }  
    ...
    * ********************************************************** */
    public function add() {
        ...
        if($this->session->userdata('role_id') != SUPER_ADMIN && $this->session->userdata('dadmin') != 1){ 
            ...
            $condition['school_id'] =  $school_id; 
            $this->data['purposes'] = $this->visitor->get_list('visitor_purposes', array('status' => 1), '', '', '', 'id', 'ASC');
            $this->data['classes'] = $this->visitor->get_list_new('classes', array('status' => 1, 'school_id'=>$school_id ), '', '', '', 'id', 'ASC');
