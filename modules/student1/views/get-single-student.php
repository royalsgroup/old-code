            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr> 
                        ...
                        <td><?php echo $student->admission_date ? date($this->global_setting->date_format, strtotime($student->admission_date)) : ""; ?></td>
                        <th><?php echo $this->lang->line('birth_date'); ?></th>
                        <td><?php echo $student->dob ?  date($this->global_setting->date_format, strtotime($student->dob)) : ""; ?></td>
                    </tr>
                    <tr>
					...
					<tr>
                         <th><?php echo $this->lang->line('rural_urban'); ?></th>
                        <td><?php echo $student->rural_urban; ?></td>
                        <th><?php echo $this->lang->line('physical_disability'); ?></th>
                        <td><?php echo $student->physical_disability; ?></td>
                    </tr>
					<tr>
                         <th><?php echo $this->lang->line('midium_instruction'); ?></th>
                        <td><?php echo $student->medium_of_instruction; ?></td>
                        <th><?php echo $this->lang->line('free_education'); ?></th>
                        <td><?php echo $student->free_education; ?></td>
                    </tr>
					<tr>
                         <th><?php echo $this->lang->line('previous_year_attended_days'); ?></th>
                        <td><?php echo $student->previous_year_attended_days; ?></td>
                        <th><?php echo $this->lang->line('facilities_by_cwsn'); ?></th>
                        <td><?php echo $student->facilities_by_cwsn; ?></td>
                    </tr>
					<tr>
                         <th><?php echo $this->lang->line('no_of_uniform_sets'); ?></th>
                        <td><?php echo $student->no_of_uniform_sets; ?></td>
                        <th><?php echo $this->lang->line('free_text_books'); ?></th>
                        <td><?php echo $student->free_text_books; ?></td>
                    </tr>
					<tr>
                         <th><?php echo $this->lang->line('free_transport'); ?></th>
                        <td><?php echo $student->free_transport; ?></td>
                        <th><?php echo $this->lang->line('free_escort'); ?></th>
                        <td><?php echo $student->free_escort; ?></td>
                    </tr>
					<tr>
                         <th><?php echo $this->lang->line('mdm_benificiary'); ?></th>
                        <td><?php echo $student->mdm_benificiary; ?></td>
                        <th><?php echo $this->lang->line('free_hostel'); ?></th>
                        <td><?php echo $student->free_hostel; ?></td>
                    </tr>
					<tr>
                         <th><?php echo $this->lang->line('special_training'); ?></th>
                        <td><?php echo $student->special_training; ?></td>
                        <th><?php echo $this->lang->line('appeared_in_last_exam'); ?></th>
                        <td><?php echo $student->appeared_in_last_exam; ?></td>
                    </tr>
					<tr>
                         <th><?php echo $this->lang->line('last_exam_passed'); ?></th>
                        <td><?php echo $student->last_exam_passed; ?></td>
                        <th><?php echo $this->lang->line('last_exam_marks'); ?></th>
                        <td><?php echo $student->last_exam_marks; ?></td>
                    </tr>
					<tr>
                         <th><?php echo $this->lang->line('trade_sector'); ?></th>
                        <td><?php echo $student->trade_sector; ?></td>
                        <th><?php echo $this->lang->line('iron_folic_acid_tablets'); ?></th>
                        <td><?php echo $student->iron_folic_acid_tablets; ?></td>
                    </tr>
					<tr>
                         <th><?php echo $this->lang->line('deworming_tablets'); ?></th>
                        <td><?php echo $student->deworming_tablets; ?></td>
                        <th><?php echo $this->lang->line('vitamin_a_supplement'); ?></th>
                        <td><?php echo $student->vitamin_a_supplement; ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $this->lang->line('reason_of_seperation'); ?></th>
                        <td><?php echo $student->reason_of_seperation; ?></td>
                        <th><?php echo $this->lang->line('date_of_seperation'); ?></th>
                        <td><?php if($student->date_of_seperation!= NULL && $student->date_of_seperation != '') { echo date('Y-m-d',strtotime($student->date_of_seperation)); } ?></td>
                    </tr>
                    <tr>
					...
					<tr>
                        ...
                        <td><?php echo $student->facilities; ?></td>
                        <th></th>
                        <td></td>
                    </tr>
                </tbody>
