                                ...
                                <div class="row">
									...
									<div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="teacher_code"  id="add_teacher_code" value="<?php echo isset($post['teacher_code']) ?  $post['teacher_code'] : ''; ?>" placeholder="<?php echo $this->lang->line('teacher_code'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="help-block"><?php echo form_error('esi'); ?></div>
                                        </div>
                                    </div>
									<div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                            ...
                            <?php echo form_open_multipart(site_url('teacher/edit/'. $teacher->id), array('name' => 'editteacher', 'id' => 'editteacher', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
									...
									<div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="national_id"><?php echo $this->lang->line('teacher_code'); ?><span class="required">*</span> </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="teacher_code"  id="edit_teacher_code" value="<?php echo isset($teacher->teacher_code) ?  $teacher->teacher_code : ''; ?>" placeholder="<?php echo $this->lang->line('employee_code'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('teacher_code'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
