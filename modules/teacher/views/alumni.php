                        ...
                        <li class="li-class-list">
                           <?php if($this->session->userdata('role_id') == SUPER_ADMIN || $this->session->userdata('dadmin') == 1){  ?>                                 
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_teacher_by_school(this.value);">
                                        <option value="<?php echo site_url('teacher/alumni/'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                    <?php foreach($schools as $obj ){ ?>
                                        <option value="<?php echo site_url('teacher/alumni/'.$obj->id); ?>" <?php if(isset($filter_school_id) && $filter_school_id == $obj->id){ echo 'selected="selected"';} ?> > <?php echo $obj->school_name; ?></option>
                                    <?php } ?>   
                                </select>
                            <?php } ?>  
                        </li>     
                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($teachers) && !empty($teachers)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'teacher', 'teacher') && $obj->leaving_reason !="Transfer"){ ?> 
                                                    <a href="<?php echo site_url('teacher/unalumni/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_unalumni_teacher_alert'); ?>');" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('unalumni'); ?> </a><br/>
                                                <?php } ?> 
