                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('teacher/lecture/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
								 ...
								 <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="teacher_id"><?php echo $this->lang->line('subject'); ?> <span class="required">*</span><?php echo $this->lang->line('teacher'); ?> 
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="disciplines"  id="edit_disciplines" >
                                            ...
                                            <option value="<?php echo $obj->id ?> " <?php  echo isset($lecture->disciplines) && $lecture->disciplines ==  $obj->id  ?  'selected="selected"' : ''; ?>><?php echo $obj->name; ?></option>
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('disciplines'); ?></div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="lecture_type"  id="lecture_type" required="required" onchange="get_video_lecture_type(this.value, 'edit');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>  
                                            <?php $types = get_video_types($lecture->lecture_type); ?>
                                            <?php foreach($types as $key=>$value){ ?>
...
<!-- Super admin js end -->
 ...
 <script type="text/javascript">
    ...
    <?php if(isset($edit)){ ?>
        edit = true;
        <?php if(isset($lecture) && !empty($lecture)){ ?>         
            discipline_id =  '<?php echo $lecture->disciplines; ?>';
         <?php } ?>  
  ...
  <script type="text/javascript">
    ...
    <?php } ?>
    get_class_by_faculty(discipline_id, '<?php echo $lecture->class_id; ?>')
