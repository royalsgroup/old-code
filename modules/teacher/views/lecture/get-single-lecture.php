        ...
        <tr>           
            <td colspan="4">
               ...
               <?php }else if($lecture->lecture_type == 'youtube'){ 
                   $video_id = get_youtube_id_from_url($lecture->video_id);
                   ?>
                    <iframe class="youtube-player" type="text/html" style="width:100%; height:350px;" height="350"
                       src="http://www.youtube.com/embed/<?php echo  $video_id; ?>" frameborder="0">
                    </iframe>
                    <center><a href ="<?php echo  $lecture->video_id; ?>" class="btn btn-primary" target="_blank" >Open in New tab</a></center>
               <?php }else if($lecture->lecture_type == 'vimeo'){ 
                    $video_id = get_vimeo_id_from_url($lecture->video_id);
                   
                   ?>
                    <iframe src="https://player.vimeo.com/video/<?php echo $video_id; ?>" style="width:100%; height:350px;" height="350" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
