                    ...
                    <div class="col-md-10 col-sm-10 col-xs-12">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group"> 
                                ...
                                <select  class="form-control col-md-7 col-xs-12" name="group_by" id="group_by" >
                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 layout-box">
                                                <div>
                                                    ...
                                                    <h3 class="head-title ptint-title" style="width: 100%;"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('library'); ?> <?php echo $this->lang->line('collection'); ?>  <?php echo $this->lang->line('report'); ?></small></h3>                
                                                    <div class="clearfix">&nbsp;</div>
                                                </div>
                                            </div>
                                                <div class="col-sm-3  col-xs-3"></div>
