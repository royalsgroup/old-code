                                ...
                                <?php if(isset($school) && !empty($school)){ ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 layout-box">
                                                <div>
                                                    ...
                                                    <h3 class="head-title ptint-title" style="width: 100%;"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('due_fee'); ?> <?php echo $this->lang->line('collection'); ?>  <?php echo $this->lang->line('report'); ?></small></h3>                
                                                    <div class="clearfix">&nbsp;</div>
                                                </div>
                                            </div>
                                                <div class="col-sm-3  col-xs-3"></div>
                                 ...
                                 <?php } ?>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('discount'); ?> <?php echo $this->lang->line('amount'); ?></th>               
                                ...
                                <tbody>   
                                    ...
                                    $count = 1; if(isset($sbalance) && !empty($sbalance)){ ?>
                                        <?php foreach($sbalance as $obj){ 
                                            $discount_amount = $obj->discount_amount ? $obj->discount_amount : 0;
                                            $paid_amount = $obj->paid_amount ? $obj->paid_amount : 0;
                                            $total_paid = $discount_amount + $paid_amount;
                                            ?>
                                        <tr>
                                            ...
                                            <td class="blue"><?php echo $obj->fee_amount; ?></td>
                                            <td class="green"><?php echo $discount_amount; ?></td>
                                            <td class="green"><?php echo $paid_amount; ?></td>
                                            <td class="red"><?php echo $obj->fee_amount - $total_paid; $total_balance += $obj->fee_amount - $total_paid; ?></td>
                                        </tr>
                                        <?php } ?>
                                        <tr>
                                            <td colspan="8"><strong><?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('balance'); ?></strong></td>
