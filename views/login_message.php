                ...
                <div class="row">                     
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <textarea name="login_message" class="form-control"><?php if(!empty($login_message) ){ echo $login_message; }else{ echo ''; } ?></textarea>
                            <div class="help-block"><?php echo form_error('login_message'); ?></div>
                        </div>
                    </div>
