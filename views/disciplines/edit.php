                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                       ...
                       <?php } ?>
                        ...
                        <?php if(has_permission(VIEW, 'academic', 'discipline')){ ?>
                        <li class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#harry"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('discipline'); ?> <?php echo $this->lang->line('add'); ?></a> </li>
                       <?php } ?>
                  ...
                  <li class="li-class-list">
                    ...
                    <div class="tab-content">
                                       ...
                                       <tbody>   
                                              ...
                                              <?php foreach($disciplines as $obj){ ?>
                                                <tr>
                                                  ...
                                                  <td><a href="<?php echo site_url('disciplines/delete/'.$obj->id); ?>" onclick="javascript: return confirm('Are you sure you want to delete this');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                    <a href="<?php echo site_url('disciplines/edit/'.$obj->id); ?>" onclick="javascript: return confirm('Are you sure you want to edit this');" class="btn btn-info btn-xs "><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('edit'); ?> </a></td>   
                                                  </tr>
                                                  <?php } ?>
                                              <?php } ?>
                                      </tbody>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="harry" >
                            <div class="x_content"> 
                        ...
                        <div  class="tab-pane fade in <?php if(isset($edit)){ echo 'active'; }?>" >
                            <div class="x_content"> 
                               <?php echo form_open(site_url('disciplines/edit'), array('name' => 'add', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="add_name" value="<?php echo isset($discipline->name) ?  $discipline->name : ''; ?>" placeholder="<?php echo $this->lang->line('discipline'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div>
