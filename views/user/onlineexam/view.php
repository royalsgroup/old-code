			...
			<?php
                        if (!empty($online_exam_validate)) {
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-9 col-xs-8 col-md-10"><?php echo date('d-m-Y',strtotime($exam->exam_from)); ?></dd>

                                <dt class="col-sm-3 col-xs-4 col-md-2"><?php echo $this->lang->line('exam') . " " . $this->lang->line('to') ?></dt>
                                <dd class="col-sm-9 col-xs-8 col-md-10"><?php echo date('d-m-Y',strtotime($exam->exam_to)); ?></dd>
        ...
        <div id="onlineexample" class="modal fade" role="dialog">
            <div class="modal-dialog modal-dialogfullwidth">
                ...
                <div class="modal-content modal-contentfull">
                  ...
                  <?php /*    <div class="questionlogo"><img src="<?php echo base_url(); ?>uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo(); ?>" alt="<?php echo $this->customlib->getAppName() ?>" /></div> */?>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.questions', function () {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "user/onlineexam/getExamForm",
