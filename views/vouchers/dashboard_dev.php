...
<div class="row ">
    ...
    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner">
            ...
            <div class="count" id="total_student_count"></div>
        </div>
    </div>
     <?php } ?>
    ...
    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner">
            ...
            <div class="count" id="total_guardian_count"></div>
        </div>
    </div>
     <?php } ?>
    ...
    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner">
            ...
            <div class="count" id="total_teacher_count"></div>
        </div>
    </div>
    <?php } ?>
    ...
    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner">
            ...
            <div class="count" id="total_employee_count"></div>
        </div>
    </div>
    <?php } ?>
            ...
            <div class="x_panel tile overflow_hidden">
                ...
                <div class="x_content">
                    ...
                    $.ajax({       
                                ...
                                data   : { school_id:school_id, ledger_id:credit_ledger_id,category : "Inventory"},               
                                async  : false,
