<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <tbody>
		...
		<tr>
            <th><?php echo $this->lang->line('required'); ?> <?php echo $this->lang->line('subjects'); ?></th>
            <td><?php echo $class->required_subjects; ?>   </td>
        </tr> 
		<tr>
            <th><?php echo $this->lang->line('optional'); ?> <?php echo $this->lang->line('subjects'); ?></th>
            <td><?php echo $class->optional_subjects; ?>   </td>
        </tr> 
		<tr>
