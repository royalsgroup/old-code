                ...
                <ul class="nav side-menu">                    
                    ...
                    if(has_permission(VIEW, 'administrator', 'setting') ||
                        ...
                        <li><a><i class="fa fa-user"></i> <?php echo $this->lang->line('administrator'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php } ?>
								<?php if(has_permission(VIEW, 'administrator', 'district')){ ?>   
                                    <li><a href="<?php echo site_url('district'); ?>"> <?php echo $this->lang->line('manage_district'); ?></a></li>
                                <?php } ?>
                        ...
                        <ul class="nav child_menu">
                            ...
                            <?php } ?>
							 <?php if(has_permission(ADD, 'hrm', 'employee')){ ?>   
                                <li><a href="<?php echo site_url('hrm/import/employee'); ?>"><?php echo $this->lang->line('import'). " ".$this->lang->line('employee'); ?></a></li>                            
                            <?php } ?>
                    ...
                    <?php if(has_permission(VIEW, 'teacher', 'teacher') || has_permission(VIEW, 'teacher', 'alumniteacher')){ ?>
						...
						<a><i class="fa fa-users"></i> <?php echo $this->lang->line('teacher'); ?> <span class="fa fa-chevron-down"></span></a>
							...
							<li><a href="<?php echo site_url('teacher/import/teacher'); ?>"><?php echo $this->lang->line('import'). " ".$this->lang->line('teacher'); ?></a> </li>  
							<?php } */?>							
                        ...
                        <li><a><i class="fa fa-dollar"></i> <?php echo $this->lang->line('payroll'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
							 <?php if(has_permission(VIEW, 'payroll', 'payscalecategory')){ ?>  
                                ...
                                <?php } ?>
								<?php if(has_permission(ADD, 'payroll', 'payscalecategory')){ ?>  
                                    <li><a href="<?php echo site_url('payroll/import/payscalecategory'); ?>"><?php echo $this->lang->line('import')." ".$this->lang->line('salary_grade'); ?></a></li>
                                <?php } ?>
                        ...
                        <li><a><i class="fa fa-calculator"></i> <?php echo $this->lang->line('accounting'); ?> <span class="fa fa-chevron-down"></span></a>
							 ...
							 <?php if(has_permission(VIEW, 'administrator', 'year')){ ?>   
                                 ...
                                 <?php } ?>
								  <?php if(has_permission(ADD, 'administrator', 'year')){ ?>   
                                    <li><a href="<?php echo site_url('administrator/import/year'); ?>"> <?php echo $this->lang->line('import'). " ".$this->lang->line('academic_year'); ?></a></li>
                                 <?php } ?>
							<?php if(has_permission(VIEW, 'accounting', 'accountgroups')){ ?>
								...
								<?php if(has_permission(ADD, 'accounting', 'accountledgers')){ ?>
                                    <li><a href="<?php echo site_url('import/accountledgers'); ?>"><?php echo $this->lang->line('import')." ".$this->lang->line('account'). " ".$this->lang->line('ledger'); ?></a></li> 
                                <?php } ?>
								...
								<?php if(has_permission(ADD, 'accounting', 'vouchers')){ ?>
                                    <li><a href="<?php echo site_url('import/vouchers'); ?>"><?php echo $this->lang->line('import')." ".$this->lang->line('voucher'); ?></a></li> 
                                <?php } ?>
                               ...
                               <?php if(has_permission(VIEW, 'accounting', 'feetype')){ ?>
								...
								<?php if(has_permission(ADD, 'accounting', 'feetype')){ ?>
                                    <li><a href="<?php echo site_url('accounting/import/feetype'); ?>"> <?php echo $this->lang->line('import')." ".$this->lang->line('fee_type'); ?></a></li> 
                                <?php } ?>
