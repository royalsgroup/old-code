        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <?php //if ($this->session->userdata('role_id') == SUPER_ADMIN || $this->session->userdata('dadmin') == 1) { 
                    ?>
                    <li><a><i class="fa fa-user"></i> <?php echo $this->lang->line('access_levels'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                    ...
                    <li><a><i class="fa fa-user"></i> <?php echo $this->lang->line('administrator'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <?php //} 
                            ?>
                            <?php //if (has_permission(VIEW, 'administrator', 'import_csv')) { 
                            ?>
                            ...
                            <?php //} 
                            ?>
                            <?php //f (has_permission(VIEW, 'administrator', 'superadmin')) { 
                            ?>
                    ...
                    ?>
                    <li>
                        <a><i class="fa fa-users"></i> <?php echo $this->lang->line('teacher'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'academic', 'section')) { ?>
                                    ...
                                    <?php } elseif ($this->session->userdata('role_id') == STUDENT) { ?>
                                        <li><a href="<?php echo site_url('academic/section/index/'); ?>"> <?php echo $this->lang->line('section'); ?> </a></li>
                                    <?php } else { ?>
                                        <li><a href="<?php echo site_url('academic/section/index/'); ?>" <?php if (empty($classes)) { ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>> <?php echo $this->lang->line('section'); ?></a>
                                            <!-- <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'academic', 'subject')) { ?>
                                    ...
                                    <?php } elseif ($this->session->userdata('role_id') == STUDENT) { ?>
                                        <li><a href="<?php echo site_url('academic/subject/index/'); ?>"> <?php echo $this->lang->line('subject'); ?> </a></li>
                                    <?php } else { ?>
                                        <li><a href="<?php echo site_url('academic/subject/index/'); ?>" <?php if (empty($classes)) { ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>> <?php echo $this->lang->line('subject'); ?></span></a>
                                            <!-- <ul class="nav child_menu">
                                                <?php foreach ($classes as $obj) { ?>
                                                    <?php if ($this->session->userdata('role_id') == GUARDIAN) { ?>
                                                        <?php if (!in_array($obj->id, $guardian_class_data)) {
                                ...
                                <?php if (has_permission(VIEW, 'academic', 'syllabus')) { ?>
                                    ...
                                    <?php } elseif ($this->session->userdata('role_id') == STUDENT) { ?>
                                        <li><a href="<?php echo site_url('academic/syllabus/index/'); ?>"> <?php echo $this->lang->line('syllabus'); ?></a> </li>
                                    <?php } else { ?>
                                        <li><a href="<?php echo site_url('academic/syllabus/index/'); ?>" <?php if (empty($classes)) { ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>><?php echo $this->lang->line('syllabus'); ?></a>
                                            <!-- <ul class="nav child_menu">
                                                <?php foreach ($classes as $obj) { ?>
                                                    <?php if ($this->session->userdata('role_id') == GUARDIAN) { ?>
                                                        <?php if (!in_array($obj->id, $guardian_class_data)) {
                                ...
                                <?php if (has_permission(VIEW, 'academic', 'material')) { ?>
                                    ...
                                    <?php } elseif ($this->session->userdata('role_id') == STUDENT) { ?>
                                        <li><a href="<?php echo site_url('academic/material/index/'); ?>"> <?php echo $this->lang->line('material'); ?></a> </li>
                                    <?php } else { ?>
                                        <li><a href="<?php echo site_url('academic/material/index/'); ?>" <?php if (empty($classes)) { ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>> <?php echo $this->lang->line('material'); ?></span></a>
                                            <!-- <ul class="nav child_menu">
                                                <?php foreach ($classes as $obj) { ?>
                                                    <?php if ($this->session->userdata('role_id') == GUARDIAN) { ?>
                                                        <?php if (!in_array($obj->id, $guardian_class_data)) {
                                ...
                                <?php if (has_permission(VIEW, 'academic', 'routine')) { ?>
                                    ...
                                    <?php } elseif ($this->session->userdata('role_id') == STUDENT) { ?>
                                        <li> <a href="<?php echo site_url('academic/routine/index/'); ?>"> <?php echo $this->lang->line('class'); ?> <?php echo $this->lang->line('routine'); ?></a></li>
                                    <?php } else { ?>
                                        <li> <a href="<?php echo site_url('academic/routine/index/'); ?>" <?php if (empty($classes)) { ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>> <?php echo $this->lang->line('class'); ?> <?php echo $this->lang->line('routine'); ?></span></a>
                                            <!-- <ul class="nav child_menu">
                                                <?php foreach ($classes as $obj) { ?>
                                                    <?php if ($this->session->userdata('role_id') == GUARDIAN) { ?>
                                                        <?php if (!in_array($obj->id, $guardian_class_data)) {
                    ...
                    ?>
                    <!-- <li><a href="<?php echo site_url('student/index'); ?>"><i class="fa fa-group"></i> <?php echo $this->lang->line('student'); ?> </a></li> -->
                    <?php //} elseif ($this->session->userdata('role_id') == SUPER_ADMIN || $this->session->userdata('dadmin') == 1) { 
                    ?>
                    ...
                    <li><a><i class="fa fa-group"></i> <?php echo $this->lang->line('student'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <?php //} 
                            ?>
                            <?php //if (has_permission(VIEW, 'student', 'alumnistudents')) { 
                            ?>
                    ...
                    <?php if (has_permission(VIEW, 'assignment', 'assignment')) { ?>
                        ...
                        ?>
                        <li><a><i class="fa fa-graduation-cap"></i> <?php echo $this->lang->line('online'); ?> <?php echo $this->lang->line('exam'); ?><span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                        ...
                        ?>
                        <li><a><i class="fa fa-graduation-cap"></i> <?php echo $this->lang->line('inventory'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <?php //if (has_permission(VIEW, 'inventory', 'issueitem')) { 
                                ?>
                                <li><a href="<?php echo site_url('issueitem/'); ?>"><?php echo $this->lang->line('issue') . " " . $this->lang->line('item'); ?> </a></li>
                                <?php //} 
                                ?>
                                <?php //if (has_permission(VIEW, 'inventory', 'itemstock')) { 
                                ?>
                                <li><a href="<?php echo site_url('itemstock/'); ?>"><?php echo $this->lang->line('item') . " " . $this->lang->line('stock'); ?> </a></li>
                                <?php //} 
                                ?>
                        ...
                        ?>
                        <?php if (
                            has_permission(VIEW, 'exam', 'grade') || has_permission(VIEW, 'exam', 'exam') || has_permission(VIEW, 'exam', 'schedule') || has_permission(VIEW, 'exam', 'suggestion') || has_permission(VIEW, 'exam', 'attendance') || has_permission(VIEW, 'exam', 'mark') ||
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <?php if (has_permission(VIEW, 'exam', 'schedule')) { ?>
                                        ...
                                        <?php } elseif ($this->session->userdata('role_id') == STUDENT) { ?>
                                            <li><a href="<?php echo site_url('exam/schedule/index/'); ?>"><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('schedule'); ?></a></li>
                                        <?php } else { ?>
                                            <li><a href="<?php echo site_url('exam/schedule/index/'); ?>" <?php if (empty($classes)) { ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('schedule'); ?></span></a>
                                                <!-- <ul class="nav child_menu">
                                                <?php foreach ($classes as $obj) { ?>
                                                    <?php if ($this->session->userdata('role_id') == GUARDIAN) { ?>
                                                        <?php if (!in_array($obj->id, $guardian_class_data)) {
                                    ...
                                    <?php if (has_permission(VIEW, 'exam', 'suggestion')) { ?>
                                        ...
                                        <?php } elseif ($this->session->userdata('role_id') == STUDENT) { ?>
                                            <li><a href="<?php echo site_url('exam/suggestion/index/'); ?>"><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('suggestion'); ?></a></li>
                                        <?php } else { ?>
                                            <li><a href="<?php echo site_url('exam/suggestion/index/'); ?>" <?php if (empty($classes)) { ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('suggestion'); ?></a>
                                                <!-- <ul class="nav child_menu">
                                                <?php foreach ($classes as $obj) { ?>
                                                    <?php if ($this->session->userdata('role_id') == GUARDIAN) { ?>
                                                        <?php if (!in_array($obj->id, $guardian_class_data)) {
                                    ...
                                    <?php if (
                                        ...
                                        <li><a href="<?php echo site_url('exam/mark/index'); ?>"> <?php echo $this->lang->line('exam_mark'); ?></span></a>
                                            <!-- <ul class="nav child_menu">
                        ...
                        //) { 
                        ?>
                        <li><a><i class="fa fa-calculator"></i> <?php echo $this->lang->line('fee'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                        ...
                        <li><a><i class="fa fa-lock"></i><?php echo $this->lang->line('help'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
